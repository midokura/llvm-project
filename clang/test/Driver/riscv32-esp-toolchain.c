...
// CXX-RV32IMAC-BAREMETAL-MULTI-ILP32: "-lstdc++" "--start-group" "-lc" "-lgloss" "-lnosys" "--end-group" "-lgcc"
...
// CXX-RV32IMAC-BAREMETAL-MULTI-NOSYSROOT-ILP32: "-lstdc++" "--start-group" "-lc" "-lgloss" "-lnosys" "--end-group" "-lgcc"
